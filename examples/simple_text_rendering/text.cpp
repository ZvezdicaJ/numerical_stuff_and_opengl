...
void RenderText(Shader<RENDER_TYPE::CUSTOM> &shader, std::string text,
...
int main() {
    ...
    Shader<RENDER_TYPE::CUSTOM> shader(basic_text_shaders::vertex_shader, "",
                                       basic_text_shaders::fragment_shader);

    unsigned shaderProgram = shader.get_shader_program();
