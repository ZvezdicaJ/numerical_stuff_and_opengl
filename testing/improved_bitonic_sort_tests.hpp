...
TEST(SORT, IMPROVED_BITONIC_AVX_REG_SORT_FLOAT) {
    {
        __m256 reg = _mm256_setr_ps(0, 1, 2, 3, 4, 5, 6, 7);
        IMPROVED_BITONIC_SORT::bitonic_sort(reg);
        float *sol = (float *)&reg;
    ...
    }
    {
        ...
        IMPROVED_BITONIC_SORT::bitonic_sort(reg2);
        // print_avx(reg2, "reg2: ");
    ...
    }
    {
        ...
        IMPROVED_BITONIC_SORT::bitonic_sort(reg3);
        // print_avx(reg2, "reg2: ");
    ...
    }
    {
        ...
        IMPROVED_BITONIC_SORT::bitonic_sort(reg0);
        float *s1 = (float *)&reg0;
...
TEST(SORT, IMPROVED_BITONIC_AVX_SORT_REG2_FLOAT) {
    {
...
TEST(SORT, IMPROVED_BITONIC_AVX_SORT_4REG_FLOAT) {
    {
        __m256 reg0 = _mm256_setr_ps(1, 2, 3, 4, 5, 6, 7, 8);
        __m256 reg1 = _mm256_setr_ps(9, 10, 11, 12, 13, 14, 15, 16);
...
TEST(SORT, IMPROVED_BITONIC_AVX_MERGE_4REG_FLOAT) {
    {
        __m256 reg0 = _mm256_setr_ps(1, 2, 3, 4, 5, 6, 7, 8);
        __m256 reg1 = _mm256_setr_ps(9, 10, 11, 12, 13, 14, 15, 16);
        __m256 reg2 = _mm256_setr_ps(17, 18, 19, 20, 21, 22, 23, 24);
        ...
        IMPROVED_BITONIC_SORT::bitonic_merge(reg0, reg1, reg2, reg3);
...
TEST(SORT, TEST_2N_IMPROVED_BITONIC_SORT_FLOAT_VER) {

    {
        ...
        IMPROVED_BITONIC_SORT::sort_2n_vector(inp0.data(), 0, 7);
        std::sort(std::begin(inp1), std::end(inp1));
...
TEST(SORT, TEST_2N_SORT_DOUBLE_VER) {

    {
        ...
        BITONIC_SORT::sort_2n_vector(inp0.data(), 0, 3);
        std::sort(std::begin(inp1), std::end(inp1));
...

    {
        ...
        inp1 = inp0;
        BITONIC_SORT::sort_2n_vector(inp1.data(), 0, 7);
...
TEST(SORT, TEST_SORT_DOUBLE_4n_VECTOR) {
    ...
    for (unsigned size = 4; size <= 2000; size += 4) {
        ...
        inp1 = inp0;
        BITONIC_SORT::sort_4n_vector(inp1.data(), 0, size - 1);
...
TEST(SORT, TEST_SORT_DOUBLE_VECTOR_ALL_CASES) {
    ...
    for (unsigned size = 1; size < 5000; size++) {
        ...
        inp1 = inp0;
        BITONIC_SORT::sort_vector(inp1, 0, size - 1);
